...
namespace VoxxWeatherPlugin.Utils
{
    internal sealed class PlayerEffectsManager
    {
        ...
        public static bool isUnderSnow;
        public static float heatTransferRate = 1f;
        public static float normalizedTemperature; // 0 - room temperature, 1 - heatstroke, -1 - hypothermia
        public static float poisoningStrength;
